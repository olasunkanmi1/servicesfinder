  ...
  return (
    <footer>
      <div className="xl:max-w-6xl m-auto px-4 sm:px-8 xl:px-0 flex flex-col py-4 space-y-6 overflow-hidden">
        <div className="flex justify-betweeen  space-x-10">
          <div className='space-y-3 w-[400px] text-gray-400 font-normal'>
            <Link href="/"> 
        ...
        <p className="items-center mx-auto mt-5 font-semibold text-gray-400"> By using this website, you understand the information being presented is provided for informational purposes only. </p>
      </div>
    </footer>
  )
}
